...
spoken.analysis('蘋果和牛奶很好吃。蘋果牛奶很好喝。很好喝的蘋果牛奶。', 'c2e')
spoken.analysis('好大的蘋果。', 'c2e')
spoken.analysis('John 和 Mary 一起吃蘋果。\n', 'c2e')
spoken.analysis('祭拜同一位神明， supreme=至高無上:N 的天神《 法拉:N 》。', 'c2e')
spoken.analysis('人造交談語言 (ASL, Artificial Spoken Language) 是一種像程式語言一樣，具有 BNF 語法規則，但ASL是用來交談的語言。', 'c2e')
spoken.analysis('測試 [超連結](https://nqu.edu.tw/abc/def) 還有 <div class="b">標記</div> 是否正確。', 'c2e')
spoken.analysis('測試 \n```js \n// 程式碼\n```\n 還有 $$數學式$$ 是否正確。', 'c2e')
