...
spoken.analysis('測試 [超連結](https://nqu.edu.tw/abc/def) 還有 <div class="b">標記</div> 是否正確。')
spoken.analysis('測試 \n```js \n// 程式碼\n```\n 還有 $$數學式$$ 是否正確。')
spoken.analysis('測試 <head>一起吃蘋果</head> 還有  <script> // 人造交談語言 </script> 。')
spoken.analysis('測試 <!-- 註解 --> 還有  http://mdbookspace.com/view/ccc/README.md 超連結 。')
